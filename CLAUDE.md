...
6. Auto Scaling + failover test (kill a pod, measure client-visible error rate/recovery time) — the real evidence for "99.99% availability," not just infra existing. **Next step.**
